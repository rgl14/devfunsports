...
@Component({
  selector: 'app-dlwise-clientpnl',
  templateUrl: './dlwise-clientpnl.component.html',
  styleUrls: ['./dlwise-clientpnl.component.css']
})
export class DlwiseClientpnlComponent implements OnInit {
  gridOptions: any;
  rowData;
  rowD;
  gridApi: any;
  ...
  constructor() {
    ...
    this.gridOptions.columnDefs = [
      {headerName: 'Client username', field: 'clusername',sort: "desc",resizable: true, sortable: true, minWidth: 100,width:150,suppressSizeToFit: true,lockPosition:true,suppressNavigable:true,cellRendererFramework: redirectComponent},
      ...
      {headerName: 'Total [Y+Z]', field: 'total',resizable: true, sortable: true, minWidth: 100,width:100,suppressSizeToFit: true,valueFormatter: numberWithCommas,cellClass: function(params) { return (params.value >= 0 ? 'profit':'loss')}},
